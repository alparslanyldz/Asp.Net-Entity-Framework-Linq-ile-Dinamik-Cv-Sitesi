...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            <img src="/web/images/a.jpg" alt="news image" class="img-fluid navimg">
            <h1 class="top_hd mt-2"><a href="index.html">Alparslan YILDIZ</a></h1>
        ...
        <div class="news" id="news">
            ...
            <p class="iner mt-md-5 text-left">
                <asp:Repeater ID="Repeater3" runat="server">
                    <ItemTemplate><%#Eval("IsDeneyimler") %></ItemTemplate>
                </asp:Repeater>
            </p>
            ...
            <div class="contact_grid_right mt-5 mx-auto text-left">
                <form action="#" method="post" runat="server">
                    <div class="row contact_top">
                        ...
                        <div class="col-sm-6">
                           <asp:TextBox ID="TextBox2" runat="server" placeholder="Mail Adresiniz..." TextMode="Email"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <asp:Button ID="Button2" runat="server" CssClass="btn btn-warning" Text="Yenile" />
                    <div class="clearfix"></div>
                </form>
            </div>
            <div class="cpy-right text-center">
                <p>
                    © 2021 Cv Projesi | Design by
					<a href="https://github.com/alparslanyldz">Alparslan YILDIZ</a>
                </p>
            </div>
        </section>
        <!-- //contact -->
